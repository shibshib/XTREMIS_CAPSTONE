...
void openNewLogFileBDF(String _fileName) {
  ...
  if (eegDataSource == DATASOURCE_XTREMIS) {
    fileoutput_bdf = new OutputFile_BDF(xt.get_fs_Hz(), nchan, _fileName);
  }
  /*
  ...
  println("XTREMIS: openNewLogFile: opened BDF output file: " + output_fname);
  output("XTREMIS: openNewLogFile: opened BDF output file: " + output_fname);
}
...
void openNewLogFileODF(String _fileName) {
  ...
  //open the new file
  if (eegDataSource == DATASOURCE_XTREMIS){
    fileoutput_odf = new OutputFile_rawtxt(xt.get_fs_Hz(), _fileName);
  }
  /*
  if (eegDataSource == DATASOURCE_GANGLION) {
  ...
  println("XTREMIS: openNewLogFile: opened ODF output file: " + output_fname);
  output("XTREMIS: openNewLogFile: opened ODF output file: " + output_fname);
}
...
void createPlaybackFileFromSD() {
  logFileName = "C:/Users/Ala/Desktop/XTREMIS files/XTREMIS/DData/converted/SDconverted-"+getDateString()+".txt";
...
public class OutputFile_BDF {
  ...
  private float ADS1299_gain = 8.0;  //assumed gain setting for ADS1299.  set by its Arduino code
  ...
  private void writeHeader(OutputStream o) {
    ...
    try {
      ...
      if (eegDataSource == DATASOURCE_XTREMIS) writeStringArrayWithPaddingTimes(labelsAux, BDF_HEADER_NS_SIZE_LABEL, o);
      ...
      if (eegDataSource == DATASOURCE_XTREMIS) writeStringArrayWithPaddingTimes(transducerAux, BDF_HEADER_NS_SIZE_TRANSDUCER_TYPE, o);
      ...
      if (eegDataSource == DATASOURCE_XTREMIS) writeStringArrayWithPaddingTimes(physicalDimensionAux, BDF_HEADER_NS_SIZE_PHYSICAL_DIMENSION, o);
      ...
      if (eegDataSource == DATASOURCE_XTREMIS) writeStringArrayWithPaddingTimes(physicalMinimumAux, BDF_HEADER_NS_SIZE_PHYSICAL_MINIMUM, o);
      ...
      if (eegDataSource == DATASOURCE_XTREMIS) writeStringArrayWithPaddingTimes(physicalMaximumAux, BDF_HEADER_NS_SIZE_PHYSICAL_MAXIMUM, o);
      ...
      if (eegDataSource == DATASOURCE_XTREMIS) writeStringArrayWithPaddingTimes(digitalMinimumAux, BDF_HEADER_NS_SIZE_DIGITAL_MINIMUM, o);
      ...
      if (eegDataSource == DATASOURCE_XTREMIS) writeStringArrayWithPaddingTimes(digitalMaximumAux, BDF_HEADER_NS_SIZE_DIGITAL_MAXIMUM, o);
      ...
      if (eegDataSource == DATASOURCE_XTREMIS) writeStringArrayWithPaddingTimes(prefilteringAux, BDF_HEADER_NS_SIZE_PREFILTERING, o);
      ...
      if (eegDataSource == DATASOURCE_XTREMIS) writeStringArrayWithPaddingTimes(nbSamplesPerDataRecordAux, BDF_HEADER_NS_SIZE_NR, o);
      ...
      if (eegDataSource == DATASOURCE_XTREMIS) writeStringArrayWithPaddingTimes(reservedAux, BDF_HEADER_NS_SIZE_RESERVED, o);
