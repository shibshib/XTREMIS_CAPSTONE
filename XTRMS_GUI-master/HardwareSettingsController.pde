...
void activateChannel(int Ichan) {
  println("XTREMIS_GUI: activating channel " + (Ichan+1));
  if (eegDataSource == DATASOURCE_XTREMIS) {
      verbosePrint("**");
      xt.changeChannelState(Ichan, true); //activate
...
void deactivateChannel(int Ichan) {
  println("XTREMIS_GUI: deactivating channel " + (Ichan+1));
  if (eegDataSource == DATASOURCE_XTREMIS) {
      verbosePrint("**");
      xt.changeChannelState(Ichan, false); //de-activate
