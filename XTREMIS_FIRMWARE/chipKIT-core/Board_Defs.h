...
*/
static const uint8_t SS   = 8;		// RA0  CS1     PGED3/VREF+/CVREF+/AN0/C3INC/RPA0/CTED1/PMD7/RA0 
static const uint8_t MISO = 5;		// RA1  SDI1    SDI1R = RPA1 = 0 
static const uint8_t MOSI =	10;		// RA4  SDO1    RPA4R = SDO1 = 3    
static const uint8_t SCK  = 7;		// RB14 SCK1    CVREF/AN10/C3INB/RPB14/VBUSON/SCK1/CTED5/RB14

/* The Digilent DSPI library uses these ports.
*/
#define	PIN_DSPI0_SS	9           // was 9    RA0  PGED3/VREF+/CVREF+/AN0/C3INC/RPA0/CTED1/PMD7/RA0          
...
/*
 * IN ITERATION 1 OF HARDWARE, TX AND RX PINS ARE MIXED UP ACCIDENTALLY. 
 *  REFER TO SCHEMATIC FOR MORE INFORMATION. 
 */
#define       _SER0_TX_OUT         PPS_IN_U1RX       // RPB3R = U1TX = 1   
#define       _SER0_TX_PIN         6                 // RB13 AN11/RPB13/CTPLS/PMRD/RB13  
#define       _SER0_RX_IN          PPS_OUT_U1TX      // U1RXR = RPB13 = 3
#define       _SER0_RX_PIN         14                // RB3  AN5/C1INA/C2INC/RTCC/RPB3/SCL2/PMWR/RB3     
...
#define _DSPI1_MISO_PIN		2			// RB2  SDI2    SDI2R = RPB2 = 4
