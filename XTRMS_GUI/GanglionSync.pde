...
class OpenBCI_Ganglion {
  ...
  private int tcpGanglionPort = 9999;
  private String tcpGanglionIP = "192.162.11.1";
  ...
  private final float fs_Hz = 500.0f;  //sample rate used by OpenBCI Ganglion board... set by its Arduino code
