...
class TopNav {
  ...
  Button filtSecondaryNotchButton;
  ...
  void initSecondaryNav(){
    ...
    println("STARTING!");
    filtSecondaryNotchButton = new Button(7 + stopButton.but_dx, 35, 70, 26, "Sec Notch\n" + dataProcessing.getShortSecondaryNotchDescription(), fontInfo.buttonLabel_size);
    filtSecondaryNotchButton.setFont(p5, 12);
    filtNotchButton = new Button(11 + stopButton.but_dx + 70, 35, 70, 26, "Notch\n" + dataProcessing.getShortNotchDescription(), fontInfo.buttonLabel_size);
    filtNotchButton.setFont(p5, 12);
    filtBPButton = new Button(14 + stopButton.but_dx + 140, 35, 70, 26, "BP Filt\n" + dataProcessing.getShortFilterDescription(), fontInfo.buttonLabel_size);
  ...
  void updateSecondaryNavButtonsColor(){
    if(colorScheme == COLOR_SCHEME_DEFAULT){
      ...
      filtSecondaryNotchButton.setColorNotPressed(color(255));
      ...
      filtSecondaryNotchButton.textColorNotActive = color(bgColor);
      ...
      filtSecondaryNotchButton.setColorNotPressed(color(57,128,204));
      ...
      filtSecondaryNotchButton.textColorNotActive = color(255);
  ...
  void mousePressed(){
    if(systemMode >= SYSTEMMODE_POSTINIT){
      ...
      if (topNav.filtSecondaryNotchButton.isMouseHere()){
        filtSecondaryNotchButton.setIsActive(true);
        incrementSecondaryNotchConfiguration();
      }
  ...
  void mouseReleased(){
    ...
    if(systemMode == SYSTEMMODE_POSTINIT){
      ...
      filtSecondaryNotchButton.setIsActive(false);
...
void incrementNotchConfiguration() {
  ...
  //topNav.filtSecondaryNotchButton.but_txt = "Sec Notch\n" + dataProcessing.getShortSecondaryNotchDescription();
  // topNav.titleMontage.string = "EEG Data (" + dataProcessing.getFilterDescription() + ")";
}

void incrementSecondaryNotchConfiguration(){
  dataProcessing.incrementSecondaryNotchConfiguration();
  
  // update button strings
 // topNav.filtSecondaryNotchButton.but_txt = "Notch\n" + dataProcessing.getShortNotchDescription();
  topNav.filtSecondaryNotchButton.but_txt = "Sec Notch\n" + dataProcessing.getShortSecondaryNotchDescription();
}
